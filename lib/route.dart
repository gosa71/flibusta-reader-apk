    ...
    builder: (context) {
      ...
      switch (settings.name) {
        ...
        case BookReaderPage.routeName:
          var readerArgs = settings.arguments as BookReaderPageArguments;
          return BookReaderPage(
            filePath: readerArgs.filePath,
            bookTitle: readerArgs.bookTitle,
          );
        case AuthorPage.routeName:
          return AuthorPage(authorId: settings.arguments);
        case GenrePage.routeName:
          return GenrePage(genre: settings.arguments);
